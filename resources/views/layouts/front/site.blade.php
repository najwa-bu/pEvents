...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/front/css/bootstrap-submenu.css')}}">
...
<!--لون ثانوي -->
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/front/css/skins/olive.css')}}">
    <link type="text/css" rel="stylesheet" href="{{ asset('assets/front/css/skins/purple.css')}}">
...
<!-- Custom JS Script -->
{{-- <script  src="{{ asset('assets/front/css/js/app.js') }}"></script> --}}
</body>
</html>