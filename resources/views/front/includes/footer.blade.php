                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                    <div class="footer-item fi-2 clearfix">
                        <div class="footer-gallery clearfix">
                            ...
                            <ul>
                                <li>
                                    <img src="assets/img/sub-property/sub-property.png" alt="small-img">
                                </li>
                                <li>
                                    <img src="assets/img/sub-property/sub-property-2.png" alt="small-img">
                                </li>
                                <li>
                                    <img src="assets/img/sub-property/sub-property-3.png" alt="small-img">
                                </li>
                                <li>
                                    <img src="assets/img/sub-property/sub-property-4.png" alt="small-img">
                                </li>
                                <li>
                                    <img src="assets/img/sub-property/sub-property-5.png" alt="small-img">
                                </li>
                                <li>
                                    <img src="assets/img/sub-property/sub-property-6.png" alt="small-img">
                                </li>
                            </ul>
                        </div>
                    </div>
